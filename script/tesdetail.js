    ...
    container.innerHTML = `
      <div class="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-6 bg-white rounded-lg shadow">
        ...
        <div>
          ...
          <button id="buy-now-btn" class="border-2 border-black font-semibold py-2 px-4 w-full rounded-lg hover:bg-black hover:text-white">Buy Now</button>
...
document.addEventListener("click", async function (e) {
  if (e.target && e.target.id === "buy-now-btn") {
    try {
